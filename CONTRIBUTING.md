...
1. [Fork](https://github.com/quic/gunyah-test-vmm/fork) and clone the repository.
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/quic/gunyah-test-vmm.git
    ```
...
1. [Submit a pull request](https://github.com/quic/gunyah-test-vmm/pulls) from your branch to `main`.
