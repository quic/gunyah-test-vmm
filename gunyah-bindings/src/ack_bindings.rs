...
pub const GUNYAH_MEM_ACCESS_MASK: u32 = 112;
...
pub mod gunyah_map_flags {
    pub type Type = ::std::os::raw::c_uint;
    pub const GUNYAH_MEM_ALLOW_READ: Type = 1;
    pub const GUNYAH_MEM_ALLOW_WRITE: Type = 2;
    pub const GUNYAH_MEM_ALLOW_EXEC: Type = 4;
    pub const GUNYAH_MEM_ALLOW_RWX: Type = 7;
    pub const GUNYAH_MEM_DEFAULT_ACCESS: Type = 0;
    pub const GUNYAH_MEM_FORCE_LEND: Type = 16;
    pub const GUNYAH_MEM_FORCE_SHARE: Type = 32;
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct gunyah_userspace_memory_region {
    pub label: u32,
    pub flags: u32,
    pub guest_phys_addr: u64,
    pub memory_size: u64,
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct gunyah_vm_firmware_config {
    pub guest_phys_addr: u64,
    pub size: u64,
}
